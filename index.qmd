...
``` python
!pip install numpy pandas geopandas matplotlib seaborn scipy openpyxl datetime
# OR
!conda install numpy pandas geopandas matplotlib seaborn scipy openpyxl datetime
```
